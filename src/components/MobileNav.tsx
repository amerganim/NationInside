  ...
  return (
    <div className="md:hidden">
      <button
        ...
        className="p-2 -ml-2 rounded-lg text-foreground hover:bg-white/5"
      >
        <Menu size={22} />
      </button>
      ...
      {open && (
        <div className="fixed inset-0 z-50" role="dialog" aria-modal="true">
          ...
          <div className="absolute left-0 top-0 h-full w-[78%] max-w-[300px] bg-[#0b1322] border-r border-border flex flex-col">
